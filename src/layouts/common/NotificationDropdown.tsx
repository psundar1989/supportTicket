					...
					<TabPane tabId="1" className="py-2 ps-2">
						<SimpleBar style={{ maxHeight: '300px' }} className="pe-2">
							<div className="text-reset notification-item d-block dropdown-item position-relative">
								<div className="d-flex">
									<div className="avatar-xs me-3">
										<span className="avatar-title bg-info-subtle text-info rounded-circle p-2  fs-16">
									...
									<div className="flex-grow-1">
										...
										<p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
											<span>
												<i className="bx bx-time"></i> Just 30 sec
												ago
											</span>
										</p>
									</div>
							...
							<div className="text-reset notification-item d-block dropdown-item position-relative active">
								<div className="d-flex">
									...
									<div className="flex-grow-1">
										...
										<p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
											<span>
												<i className="bx bx-time"></i> 48 min ago
											</span>
										</p>
									</div>
									<div className="px-2 fs-15">
							...
							<div className="text-reset notification-item d-block dropdown-item position-relative">
								<div className="d-flex">
									<div className="avatar-xs me-3">
										<span className="avatar-title bg-danger-subtle text-danger rounded-circle p-2 fs-16">
									...
									<div className="flex-grow-1">
										...
										<p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
											<span>
												<i className="bx bx-time"></i> 2 hrs ago
											</span>
										</p>
									</div>
									<div className="px-2 fs-15">
							...
							<div className="text-reset notification-item d-block dropdown-item position-relative">
								<div className="d-flex">
									...
									<div className="flex-grow-1">
										...
										<p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
											<span>
												<i className="bx bx-time"></i> 4 hrs ago
											</span>
										</p>
									</div>
									<div className="px-2 fs-15">
							...
							<div className="text-reset notification-item d-block dropdown-item">
								<div className="d-flex">
									...
									<div className="flex-grow-1">
										...
										<p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
											<span>
												<i className="bx bx-time"></i> 30 min ago
											</span>
										</p>
									</div>
									<div className="px-2 fs-15">
							...
							<div className="text-reset notification-item d-block dropdown-item">
								<div className="d-flex">
									...
									<div className="flex-grow-1">
										...
										<p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
											<span>
												<i className="bx bx-time"></i> 10 hrs ago
											</span>
										</p>
									</div>
									<div className="px-2 fs-15">
							...
							<div className="text-reset notification-item d-block dropdown-item">
								<div className="d-flex">
									...
									<div className="flex-grow-1">
										...
										<p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
											<span>
												<i className="bx bx-time"></i> 3 days ago
											</span>
										</p>
									</div>
									<div className="px-2 fs-15">
