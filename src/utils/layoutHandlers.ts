import {changeHTMLAttribute} from "./commonFunctions";
...
export const changeLayoutMode = (layoutMode : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({layoutModeType:layoutMode}));
    } catch (error) { 
        console.log(error);
    }
};
...
export const changeSidebarVisibility = (sidebarVisibilitytype : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({sidebarVisibilitytype:"show"}));
    } catch (error) { }
};
...
export const changeLeftsidebarViewType = (leftsidebarViewtype : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({leftSidebarViewType:leftsidebarViewtype}));
    } catch (error) {
        // console.log(error);
    }
};
...
export const changeLeftsidebarSizeType = (leftsidebarSizetype : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({leftsidbarSizeType:leftsidebarSizetype}));
...
export const changeSidebarTheme = (theme : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({leftSidebarType:theme}));
    } catch (error) {
        // console.log(error);
    }
};
...
export const changeLayoutWidth = (layoutWidth : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({layoutWidthType:layoutWidth}));
    } catch (error) {
        return error;
    }
};
...
export const changeLayoutPosition = (layoutposition : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({layoutPositionType:layoutposition}));
    } catch (error) {
        // console.log(error);
    }
};
...
export const changeTopbarTheme = (topbarTheme : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({topbarThemeType:topbarTheme}));
...
export const changeLayout = (layout : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({layoutType:layout}));
    } catch (error) { }
};
...
export const changeSidebarImageType = (leftsidebarImagetype : any) => async (dispatch : any) => {
    try {
        ...
        dispatch(updateLayout({leftSidebarImageType:leftsidebarImagetype}));
    } catch (error) {
        // console.log(error);
    }
};
